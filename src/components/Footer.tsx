        ...
        <>
            {isHome && (
                <div style={{ textAlign: 'center', marginBottom: 8, fontSize: 12, color: '#000', letterSpacing: 0.5, gap: '2rem', display: 'flex', justifyContent: 'center' }} className="footer-credits">
                    ...
                    <span>
                        {t("credits.devLabel")}: <a className="footer-credits__link" href="https://niccolo.dev" target="_blank" rel="noreferrer">Niccolò Maffioli</a>, <strong>Riccardo Marchesi</strong>
                    </span>
                </div>
            )}
