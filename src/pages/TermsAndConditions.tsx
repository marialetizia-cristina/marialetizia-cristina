...
const copy = {
  it: {
    ...
    draftBody: "Questa pagina contiene la struttura predisposta per i termini di vendita. Aree di consegna, tempi, costi e procedure operative devono essere confermati da Marialetizia e il testo deve essere verificato da un professionista prima di attivare gli acquisti reali.",
    updated: "Ultimo aggiornamento della bozza: 29 agosto 2026.",
    sections: [
      ["1. Informazioni sul venditore", ["Venditore: Marialetizia Cristina.", "Partita IVA: 03018010185.", "Sede legale e operativa: Via G. Marconi, 12, 27051 Cava Manara (PV), Italia.", "Indirizzo e-mail per assistenza e reclami: marialetizia.cristina@gmail.com."]],
      ...
      ["3. Prodotti e personalizzazioni", ["Le caratteristiche essenziali, il prezzo e la natura fisica o digitale di ciascun prodotto sono indicati nella relativa scheda.", "I prodotti e servizi acquistabili tramite il sito sono realizzati su richiesta del cliente e prevedono un’attività di progettazione, elaborazione e/o personalizzazione grafica svolta sulla base delle indicazioni fornite al momento dell’ordine. Gli articoli indicati come personalizzabili non costituiscono prodotti standard già realizzati: il prezzo può essere predeterminato quando le caratteristiche della prestazione consentono di definirne anticipatamente il corrispettivo.", "Il cliente è responsabile della correttezza dei testi, nomi, immagini e istruzioni inviati per la personalizzazione e deve avere il diritto di utilizzare i materiali trasmessi.", "Quando applicabile, prove preliminari o bozze vengono inviate al cliente tramite e-mail affinché possa esaminarle e approvarle prima della finalizzazione del lavoro.", "Il cliente può richiedere revisioni ragionevoli per assicurarsi che il lavoro finale rispecchi i requisiti e le preferenze concordati per l’incarico. Salvo diversa indicazione nella scheda prodotto o nel relativo preventivo, le revisioni che rimangono entro l’ambito del lavoro originariamente concordato non comportano costi aggiuntivi.", "Le richieste che modificano sostanzialmente il soggetto originario, le specifiche, il prodotto, i materiali o l’ambito dell’incarico possono essere considerate una modifica dell’ordine originario anziché una revisione. Qualora tale modifica comporti lavoro, materiali o costi aggiuntivi, l’eventuale importo supplementare sarà comunicato al cliente e concordato prima dell’esecuzione del lavoro modificato."]],
  ...
  en: {
    ...
    draftBody: "This page provides the structure for the terms of sale. Delivery areas, timing, costs and operating procedures must be confirmed by Marialetizia, and the text must be reviewed by a professional before real purchases are enabled.",
    updated: "Draft last updated: 29 August 2026.",
    sections: [
      ["1. Seller information", ["Seller: Marialetizia Cristina.", "VAT number: 03018010185.", "Registered and operating address: Via G. Marconi, 12, 27051 Cava Manara (PV), Italy.", "Email address for support and complaints: marialetizia.cristina@gmail.com."]],
      ...
      ["3. Products and customization", ["The main characteristics, price and physical or digital nature of each product are stated on its product page.", "Products and services available for purchase through the website are created at the customer’s request and involve graphic design, processing and/or customization carried out according to the instructions provided when the order is placed. Items described as customizable are not standard, pre-made products: the price may be determined in advance when the characteristics of the work make it possible to establish the amount beforehand.", "Customers are responsible for the accuracy of the text, names, images and instructions supplied for customization and must have the right to use submitted materials.", "Where applicable, preliminary proofs or drafts are sent to the customer by email for review and approval before the work is finalized.", "The customer may request reasonable revisions to ensure that the final work reflects the requirements and preferences agreed for the commission. Unless otherwise stated on the product page or in the applicable quote, revisions that remain within the originally agreed scope of the work do not incur an additional charge.", "Requests that substantially change the original subject, specifications, product, materials or scope of the commission may be treated as a change to the original order rather than a revision. Where such a change results in additional work, materials or costs, any additional amount will be communicated to the customer and agreed before the changed work is carried out."]],
