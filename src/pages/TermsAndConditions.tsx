...
const copy = {
  it: {
    ...
    sections: [
      ...
      ["2. Ambito di applicazione", ["Questi termini disciplinano gli acquisti effettuati attraverso il sito e-commerce da consumatori finali. Le richieste di idee regalo completamente personalizzate e le richieste di preventivo non costituiscono automaticamente un ordine o un acquisto.", "Un contratto di vendita nasce soltanto secondo le modalità che saranno indicate nel preventivo accettato o nella conferma dell’ordine WooCommerce."]],
      ["3. Prodotti e personalizzazioni", ["Le caratteristiche essenziali, il prezzo e la natura fisica o digitale di ciascun prodotto sono indicati nella relativa scheda.", "Il cliente è responsabile della correttezza dei testi, nomi, immagini e istruzioni inviati per la personalizzazione e deve avere il diritto di utilizzare i materiali trasmessi.", "Eventuali modalità di approvazione delle bozze e numero di revisioni incluse: [DA DEFINIRE]."]],
  ...
  en: {
    ...
    sections: [
      ...
      ["2. Scope", ["These terms govern purchases made through the online shop by final consumers. Fully custom gift requests and quote requests do not automatically constitute an order or purchase.", "A sales contract is formed only according to the process stated in an accepted quote or WooCommerce order confirmation."]],
      ["3. Products and customization", ["The main characteristics, price and physical or digital nature of each product are stated on its product page.", "Customers are responsible for the accuracy of the text, names, images and instructions supplied for customization and must have the right to use submitted materials.", "Proof approval process and number of included revisions: [TO BE DEFINED]."]],
