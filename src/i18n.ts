  ...
  en: {
    translation: {
      ...
      product: {
        ...
        commercialDetails: "Commission and purchase details",
        notForSale: "Project not for sale",
      },
      products: {
      ...
      cart: {
        ...
        attachments: "Attached files", noAttachments: "No files attached", moreAttachments: "More attached files",
      ...
      request: {
        ...
        fields: {
          ...
          desiredDeliveryDateHelp: "Indicate when you would like to receive the finished work. The date is a preference and will be confirmed based on production time.",
  ...
  it: {
    translation: {
      ...
      product: {
        ...
        commercialDetails: "Dettagli della commissione e dell’acquisto",
        notForSale: "Progetto non in vendita",
      },
      products: {
      ...
      cart: {
        ...
        attachments: "File allegati", noAttachments: "Nessun file allegato", moreAttachments: "Altri file allegati",
      ...
      request: {
        ...
        fields: {
          ...
          desiredDeliveryDate: "Data di consegna desiderata",
          desiredDeliveryDateHelp: "Indica quando vorresti ricevere il lavoro finito. La data è una preferenza e verrà confermata in base ai tempi di realizzazione.",
